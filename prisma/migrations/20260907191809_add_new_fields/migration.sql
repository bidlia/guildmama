/*
  ...
  - You are about to drop the column `games` on the `Profile` table. All the data in the column will be lost.
  - You are about to drop the column `platforms` on the `Profile` table. All the data in the column will be lost.
...
CREATE TABLE "new_Profile" (
    ...
    "ownedGamesMask" INTEGER NOT NULL DEFAULT 0,
